...
periodics::CDistancemonitor g_distancemonitor(g_baseTick * 30, g_hcsr04_1, g_hcsr04_2, g_hcsr04_3, g_speedingDriver, g_rpi);
...
drivers::CSerialMonitor::CSerialSubscriberMap g_serialMonitorSubscribers = {
    ...
    {"distanceMonitor",mbed::callback(&g_distancemonitor,   &periodics::CDistancemonitor::serialCallbackDISTANCEMONcommand),}
};
